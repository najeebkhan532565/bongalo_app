...
class Wishlist_Detail extends StatefulWidget {
  ...
  static const routename="Wishlist_Detail";

  @override
  State<Wishlist_Detail> createState() => _Wishlist_DetailState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title:Text("Kigali Trip",style: getLightBlackstyle(16, FontWeight.w600)
        ),
        elevation: 0,
        actions: [
          InkWell(
            ...
            children: [
                  ...
                  Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text("Add dates",style: getLightBlackstyle(10, FontWeight.w400),)

                              :

                          Text('${DateFormat('dd MMM').format(daterange!.start)}'+"-"+'${DateFormat('dd MMM').format(daterange!.end)}',style: getLightBlackstyle(10, FontWeight.w400),),
              ...
              InkWell(
                ...
                child: guests==0?Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: [
                        Text("Add guests",style: getLightBlackstyle(10, FontWeight.w400),),
                        Icon(Icons.expand_more,size: 15,)
                      ],
                    )
                ...
                Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: [
                        Text("${guests} guests",style: getwhitestyle(10, FontWeight.w400),),
                        Icon(Icons.expand_more,size: 15,color: Colors.white,)
                      ],
                    )
              ...
              Row(
                children: [
                  ...
                  Text("Invite",style: getbluestyle(14, FontWeight.w500),)
                ],
              )
