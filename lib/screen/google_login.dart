...
class Google_Log_in extends StatefulWidget {
  static const routename="Google_Log_in";


  @override
  State<Google_Log_in> createState() => _Google_Log_inState();
}

class _Google_Log_inState extends State<Google_Log_in> {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Container(
              margin:EdgeInsets.only(left:width*0.05) ,
              child: Text('Kindly provide us with your login details.',style: TextStyle(fontWeight: FontWeight.w400,color: Color(0xff6B6B75),fontSize: 14,fontFamily: 'Inter-Regular'),)),
                ...
                child: Container(
                  ...
                  child: ListView(
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          Navigator.of(context).pushNamed(Forget_Password.routename);
                        },
                        child: Container(
